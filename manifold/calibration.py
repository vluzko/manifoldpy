...
def bet_counts(yes_probs: np.ndarray, no_probs: np.ndarray, decimals: int) -> np.ndarray:
...
def binary_calibration(yes_probs: np.ndarray, no_probs: np.ndarray, decimals: int=1) -> np.ndarray:
...
def beta_binomial_calibration(yes_probs: np.ndarray, no_probs: np.ndarray, decimals: int=1) -> np.ndarray:
...
def overall_calibration(yes_probs: np.ndarray, no_probs: np.ndarray, decimals: int=1) -> np.ndarray:
    ...
    beta_interval, beta_means = beta_binomial_calibration(yes_probs, no_probs, decimals=1)
